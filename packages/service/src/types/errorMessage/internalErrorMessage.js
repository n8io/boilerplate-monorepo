const InternalErrorMessage = {
  ...
  FAILED_TO_EMAIL_PASSWORD_RESET: 'Failed to send password reset email',
  ...
  FAILED_TO_RESET_PASSWORD_TOKEN_MISMATCH:
  ...
  FAILED_TO_SEND_OTP_EMAIL: 'Failed to send one-time password email',
